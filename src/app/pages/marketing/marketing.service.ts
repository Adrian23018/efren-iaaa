...
export class MarketingService {
  ...
  getPurchaseSources(): Observable<PurcharseSource[]> {
    return this.http.get<PurcharseSource[]>(
      `${this.apiDasboardUrl}/${environment.endpoints.marketing}`
    );
  }
  ...
  //     interval, type
  //   };
  //   return this.http.post<Metrics>(`${this.apiDasboardUrl}/${environment.endpoints.marketing}`, body).pipe(
  //     map((response) => {
  //       return response;
  //     }),
  //   );
  ...
  getMarketings(): Observable<any> {
    return this.http.get<any>(`${this.apiDasboardUrl}/${environment.endpoints.marketing}`, {}).pipe(
